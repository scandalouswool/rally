        ...
        <div className="container">
          <div className="row">
            <div className="col-sm-4">
              <h3 className="text-center card"><span className="glyphicon glyphicon-fast-forward" aria-hidden="true"></span><br></br>All we know is fast</h3>
            ...
            <div className="col-sm-4">
              <h3 className="text-center card"><span className="glyphicon glyphicon-cloud-upload" aria-hidden="true"></span><br></br>Distribute your project</h3>
            ...
            <div className="col-sm-4">
              <h3 className="text-center card"><span className="glyphicon glyphicon-queen" aria-hidden="true"></span><br></br>See it for yourself</h3>
